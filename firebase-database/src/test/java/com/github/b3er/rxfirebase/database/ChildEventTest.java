...
public class ChildEventTest {
  ...
  @Mock DataSnapshot mockDataSnapshot1;

  @Mock DataSnapshot mockDataSnapshot2;

  @Before public void setup() {
    MockitoAnnotations.initMocks(this);
  }

  @Test public void testChildAddEvent_equals_dataSnapshot() {
    ...
    assertThat(a).isEqualTo(a).isNotEqualTo(null).isEqualTo(b).isNotEqualTo(c);

    assertThat(a.hashCode()).isEqualTo(b.hashCode()).isNotEqualTo(c.hashCode());
  }

  @Test public void testChildAddEvent_equals_previousChildName() {
    ChildAddEvent a = ChildAddEvent.create(mockDataSnapshot1, "foo");
    ChildAddEvent b = ChildAddEvent.create(mockDataSnapshot1, "foo");
    ChildAddEvent c = ChildAddEvent.create(mockDataSnapshot1, "bar");
    ChildAddEvent d = ChildAddEvent.create(mockDataSnapshot1, null);

    assertThat(a).isEqualTo(a).isNotEqualTo(null).isEqualTo(b).isNotEqualTo(c).isNotEqualTo(d);
  ...
  @Test public void testChildAddEvent_toString() {
    ChildAddEvent e = ChildAddEvent.create(mockDataSnapshot1, "foo");

    assertThat(e.toString()).startsWith("ChildAddEvent");
  }

  @Test public void testChildChangeEvent_equals_dataSnapshot() {
  ...
  @Test public void testChildChangeEvent_equals_previousChildName() {
    ChildChangeEvent a = ChildChangeEvent.create(mockDataSnapshot1, "foo");
    ChildChangeEvent b = ChildChangeEvent.create(mockDataSnapshot1, "foo");
    ...
    assertThat(a).isEqualTo(b).isNotEqualTo(c).isNotEqualTo(d);
  ...
  @Test public void testChildChangeEvent_toString() {
    ChildChangeEvent e = ChildChangeEvent.create(mockDataSnapshot1, "foo");

    assertThat(e.toString()).startsWith("ChildChangeEvent");
  }

  @Test public void testChildMoveEvent_equals_dataSnapshot() {
  ...
  @Test public void testChildMoveEvent_toString() {
    ChildMoveEvent e = ChildMoveEvent.create(mockDataSnapshot1, "foo");

    assertThat(e.toString()).startsWith("ChildMoveEvent");
  }

  @Test public void testChildRemoveEvent_equals() {
  ...
  @Test public void testChildRemoveEvent_toString() {
    ChildRemoveEvent e = ChildRemoveEvent.create(mockDataSnapshot1);

    assertThat(e.toString()).startsWith("ChildRemoveEvent");
  }
}
