...
```groovy
compile ('com.github.b3er.rxfirebase:firebase-auth:10.1.1') {
    transitive = false
}
```
...
```groovy
compile ('com.github.b3er.rxfirebase:firebase-auth-kotlin:10.1.1') {
    transitive = false
}
```
...
```groovy
compile ('com.github.b3er.rxfirebase:firebase-database:10.1.1') {
    transitive = false
}
```
...
```groovy
compile ('com.github.b3er.rxfirebase:firebase-database-kotlin:10.1.1') {
    transitive = false
}
```
...
```groovy
compile ('com.github.b3er.rxfirebase:firebase-storage:10.1.1') {
    transitive = false
}
```
...
```groovy
compile ('com.github.b3er.rxfirebase:firebase-storage-kotlin:10.1.1') {
    transitive = false
}
```
