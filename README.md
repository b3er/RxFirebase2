...
```groovy
compile ('com.github.b3er:firebase-auth:10.1.0') {
    transitive = false
}
```
...
```groovy
compile ('com.github.b3er:firebase-auth-kotlin:10.1.0') {
    transitive = false
}
```
...
```groovy
compile ('com.github.b3er:firebase-database:10.1.0') {
    transitive = false
}
```
...
```groovy
compile ('com.github.b3er:firebase-database-kotlin:10.1.0') {
    transitive = false
}
```
